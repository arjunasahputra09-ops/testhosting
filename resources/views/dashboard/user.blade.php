...
<div id="dashboard" class="opacity-0 translate-y-3 transition-all duration-700">
    ...
    <!-- ===================== HEADER ===================== -->
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Dashboard Petugas Arsip</h2>
        <p class="text-sm text-gray-500">
            Ringkasan aktivitas pengelolaan arsip statis
        </p>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        $cards = [
            ...
            ['title'=>'Arsip Digital','value'=>$arsipDigital,'icon'=>'storage','color'=>'bg-emerald-600'],
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="text-sm text-gray-500 font-semibold mb-3">
    ...
    <div class="bg-white p-4 rounded-xl shadow">
        ...
        <p class="text-xs text-gray-500 mb-4">5 arsip terakhir yang diinput</p>
