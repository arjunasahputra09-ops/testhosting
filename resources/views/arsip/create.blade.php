...
@section('title', 'Input Arsip Baru')
        ...
        <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <input type="text" id="no_urut" name="no_urut" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('no_urut') }}">
                </div>
                <div>
                    <label for="pencipta_arsip" class="block text-sm font-medium text-gray-700 mb-1">Pencipta Arsip</label>
                    <input type="text" id="pencipta_arsip" name="pencipta_arsip" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('pencipta_arsip') }}">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <input type="text" id="kode_klasifikasi" name="kode_klasifikasi" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('kode_klasifikasi') }}" required>
                </div>
                <div>
                    ...
                    <select id="jenis_arsip" name="jenis_arsip" class="w-full rounded-lg shadow-sm border-gray-300" required>
                        ...
                        <option value="Surat" {{ old('jenis_arsip') == 'Surat' ? 'selected' : '' }}>Surat</option>
            ...
            <div class="mb-4">
                ...
                <textarea id="uraian_masalah" name="uraian_masalah" rows="3" class="w-full rounded-lg shadow-sm border-gray-300" required>{{ old('uraian_masalah') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <input type="text" id="kurun_waktu" name="kurun_waktu" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('kurun_waktu') }}" placeholder="Contoh: 2023 atau 2020-2023" required>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <input type="text" id="jumlah_berkas" name="jumlah_berkas" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('jumlah_berkas') }}" placeholder="Contoh: 1 Berkas / 2 Lembar">
                </div>
                <div>
                    <label for="no_boks" class="block text-sm font-medium text-gray-700 mb-1">No. Boks</label>
                    <input type="text" id="no_boks" name="no_boks" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('no_boks') }}">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="keterangan" name="keterangan" rows="2" class="w-full rounded-lg shadow-sm border-gray-300">{{ old('keterangan') }}</textarea>
            </div>

            <!-- Baris 7: Upload File -->
            <div class="mb-6">
                <label for="file" class="block text-sm font-medium text-gray-700 mb-1">Upload File (Opsional)</label>
                <input type="file" id="file" name="file" class="w-full border border-gray-300 rounded-lg p-2 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                <small class="text-gray-500">Format: PDF, DOC, DOCX, JPG, PNG (max 100MB)</small>
            </div>
